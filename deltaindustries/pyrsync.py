...
def joindeltas(deltaBase, deltaAdd):
    """
    Ugly hack! A -1 will be added to indicate a seek(0) on the client.
    Then, the following delta will be appended.
